...
**實現位置**: `cmd/demo/demo10.go`

**實現內容：**
- ✅ 場景 1: 基本訂閱發布（單個訂閱者）
- ✅ 場景 2: 多個訂閱者監聽同一事件
- ✅ 場景 3: 訂閱者離線處理（健康檢查、自動清理）
- ✅ 場景 4: 消息持久化（保證消息不丟失、支持斷線重連）
